...
export default function Home() {
  ...
  useEffect(() => {
    const ids = ["about", "projects", "certificates", "journey"];
      ...
      >
        <div className="layout-grid">
          ...
          <main className="main-content">
            ...
            <section id="certificates" className="section-block" aria-label="Sertifikatlar">
              <SectionHeader label="Sertifikatlar" />
              <ul className="group/list" style={{ listStyle: "none" }}>
                {certificates.map((cert) => (
                  <li key={cert.id} style={{ marginBottom: "40px" }}>
                    <div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                      ...
                      <div className="z-10 sm:col-span-6">
                        ...
                        <p style={{ color: "#5eead4", fontSize: "0.8rem", fontWeight: 500, marginTop: "4px" }}>
                          {cert.issuer}
                        </p>
